...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemStrings = { R.string.attach_take_pic, R.string.attach_tp, R.string.attach_hongbao };
    protected int[] itemdrawables = { R.drawable.ease_chat_takepic_selector, R.drawable.tpicon,
            R.drawable.hbicon };
...
//        messageList.setAvatarShape(1);
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
            ...
            sharedPreferences.edit().putString("user",username+"&"+url+"&"+message.getFrom());
            // group message
