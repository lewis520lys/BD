...
private static String encodingCharset = "UTF-8";
	...
	public static void main(String[] args) {
		...
		String SECRET_KEY = AppCof.SECRET_KEY;//密钥
		String encode_key = sha1(SECRET_KEY);
		String sign = hmacSign(method,encode_key);

		System.out.println("encode_key:" + encode_key);
		System.out.println("sign:" + sign);
	}
	public static String  getSign(String method){
		String SECRET_KEY = AppCof.SECRET_KEY;//密钥
		String encode_key = sha1(SECRET_KEY);
		String sign = hmacSign(method,encode_key);
		return sign;
