...
import com.beidou.db.InviteMessgeDao;
import com.beidou.db.UserDao;
import com.beidou.domain.RobotUser;
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    Log.e("sss","helper接收到的用户名：" + userName + "helper接收到的id：" + userId + "helper头像：" + userPic);
